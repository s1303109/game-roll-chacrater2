...
MAP9_1_FROM_MAP9_SPAWN = (320, 804)
MAP9_FROM_MAP9_1_SPAWN = (768, 192)
...
MAP_REGISTRY = {
    ...
    MAP9_ID: _map_entry(
        ...
        (
            ...
            {
                "rect": MAP9_PORTAL_TO_MAP9_1_RECT_PX,
                "target_map_id": MAP9_1_ID,
                "target_spawn": MAP9_1_FROM_MAP9_SPAWN,
                "entry_move_y_sign": -1,
                "preload_pad_px": 96,
            },
        ),
    ),
    MAP9_1_ID: _map_entry(
        "out_map9_1",
        "map9_1_tileset",
        (
            {
                "rect": MAP9_1_PORTAL_TO_MAP9_RECT_PX,
                "target_map_id": MAP9_ID,
                "target_spawn": MAP9_FROM_MAP9_1_SPAWN,
                "entry_move_y_sign": 1,
                "preload_pad_px": 96,
            },
        ),
    ...
    MAP11_ID: _map_entry(
        ...
        (
            ...
            {
                "rect": MAP11_PORTAL_TO_MAP11_1_RECT_PX,
                "target_map_id": MAP11_1_ID,
                "target_spawn": MAP11_1_FROM_MAP11_SPAWN,
                "entry_move_y_sign": -1,
                "preload_pad_px": 96,
            },
        ),
    ),
    MAP11_1_ID: _map_entry(
        "out_map11_1",
        "map11_1_tileset",
        (
            {
                "rect": MAP11_1_PORTAL_TO_MAP11_RECT_PX,
                "target_map_id": MAP11_ID,
