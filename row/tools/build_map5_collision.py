...
SRC_COLLISION_PATH = Path("/workspace/map5 collision.jpeg")
OUT_DIR = Path("/workspace/row/assets/out_map5")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Build Map5 collision from red mask image (16x16, red>=20% => blocked)."
    )
