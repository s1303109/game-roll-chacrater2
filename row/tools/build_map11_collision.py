...
SRC_COLLISION_PATH = Path("/workspace/maps 11 collision.jpeg")
OUT_DIR = Path("/workspace/row/assets/out_map11")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Build Map11 collision from red mask image (16x16, red>=20% => blocked)."
    )
