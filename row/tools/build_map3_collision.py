...
SRC_COLLISION_PATH = Path("/workspace/maps 3 collision.jpeg")
OUT_DIR = Path("/workspace/row/assets/out_map3")
...
def main():
    ...
    if not OUT_MAP_JSON_PATH.exists():
        raise SystemExit("missing map.json: %s" % OUT_MAP_JSON_PATH)
