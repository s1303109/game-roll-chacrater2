...
SRC_COLLISION_PATH = Path("/workspace/maps 8 collision.jpeg")
OUT_DIR = Path("/workspace/row/assets/out_map8")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Build Map8 collision from red mask image (16x16, red>=20% => blocked)."
    )
