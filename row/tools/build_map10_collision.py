...
SRC_COLLISION_PATH = Path("/workspace/maps 10 collision.jpeg")
OUT_DIR = Path("/workspace/row/assets/out_map10")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Build Map10 collision from red mask image (16x16, red>=20% => blocked)."
    )
