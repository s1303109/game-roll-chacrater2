...
SRC_COLLISION_PATH = Path("/workspace/map6 collision.jpeg")
OUT_DIR = Path("/workspace/row/assets/out_map6")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Build Map6 collision from red mask image (16x16, red>=20% => blocked)."
    )
