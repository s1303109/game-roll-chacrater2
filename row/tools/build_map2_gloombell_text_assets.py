...
DIALOGUE_ASSETS = (
    ("map2_gloombell_opening_01.png", OPENING_LINES[0]),
    ("map2_gloombell_opening_02.png", OPENING_LINES[1]),
    ("map2_gloombell_opening_03.png", OPENING_LINES[2]),
    ("map2_gloombell_look_01.png", LOOK_LINES[0]),
    ("map2_gloombell_look_02.png", LOOK_LINES[1]),
    ("map2_gloombell_call_01.png", CALL_LINES[0]),
    ("map2_gloombell_call_02.png", CALL_LINES[1]),
    ("map2_gloombell_call_03.png", CALL_LINES[2]),
    ("map2_gloombell_wait_01.png", WAIT_LINES[0]),
    ("map2_gloombell_wait_02.png", WAIT_LINES[1]),
    ("map2_gloombell_wait_03.png", WAIT_LINES[2]),
    ("map2_gloombell_mercy_01.png", MERCY_LINES[0]),
    ("map2_gloombell_mercy_02.png", MERCY_LINES[1]),
    ("map2_gloombell_mercy_03.png", MERCY_LINES[2]),
)
ACT_ASSETS = (
...
def render_act_asset(filename: str, text: str, font: ImageFont.FreeTypeFont) -> None:
    ...
    canvas_w = text_w + 8
    canvas_h = text_h + 6
    image = Image.new("RGBA", (canvas_w, canvas_h), TRANSPARENT)
    draw = ImageDraw.Draw(image)
    x = 4 - bbox[0]
