...
add_library(usermod_shared_lovyangfx_core INTERFACE)

target_sources(usermod_shared_lovyangfx_core INTERFACE
...
target_include_directories(usermod_shared_lovyangfx_core INTERFACE
    ${LGFX_DIR}/src
    $ENV{IDF_PATH}/components/efuse/include
    $ENV{IDF_PATH}/components/efuse/esp32s3/include
)

target_compile_definitions(usermod_shared_lovyangfx_core INTERFACE
    LGFX_USE_V1=1
    ESP_PLATFORM=1
)
