...
extern "C" {
#endif
void game_a_lgfx_init_impl(void);
void game_a_lgfx_fill_impl(uint16_t color);
void game_a_lgfx_draw_text_impl(int x, int y, const char *text, uint16_t color);
void game_a_lgfx_draw_rect_impl(int x, int y, int w, int h, uint16_t color);
void game_a_lgfx_draw_circle_impl(int x, int y, int r, uint16_t color);
void game_a_lgfx_clear_impl(void);
void game_a_lgfx_set_rotation_impl(int rotation);
void game_a_lgfx_set_brightness_impl(int brightness);
void game_a_lgfx_set_swap_bytes_impl(bool swap);
void game_a_lgfx_sprite_create_impl(int w, int h, bool use_psram);
void game_a_lgfx_sprite_fill_impl(uint16_t color);
void game_a_lgfx_sprite_push_impl(int x, int y);
bool game_a_lgfx_tile_setup_impl(int tile_size, int map_w, int map_h, int view_w, int view_h, bool use_psram);
bool game_a_lgfx_tile_load_impl(const uint8_t *tileset_data, size_t tileset_len, const uint8_t *tilemap_data, size_t tilemap_len);
bool game_a_lgfx_tile_load_files_impl(const char *tileset_path, const char *tilemap_path);
int game_a_lgfx_tile_loader_mode_impl(void);
int game_a_lgfx_tile_last_error_impl(void);
bool game_a_lgfx_slot_load_files_impl(int slot_id, uint32_t map_token, uint32_t tileset_token, const char *tileset_path, const char *tilemap_path, int tile_size, int map_w, int map_h);
bool game_a_lgfx_slot_begin_load_files_impl(int slot_id, uint32_t map_token, uint32_t tileset_token, const char *tileset_path, const char *tilemap_path, int tile_size, int map_w, int map_h);
int game_a_lgfx_slot_pump_load_impl(int slot_id, size_t max_bytes);
bool game_a_lgfx_slot_cancel_load_impl(int slot_id);
bool game_a_lgfx_slot_select_impl(int slot_id, bool force_full_redraw);
bool game_a_lgfx_slot_release_impl(int slot_id);
void game_a_lgfx_slot_release_all_impl(void);
bool game_a_lgfx_slot_has_map_impl(int slot_id, uint32_t map_token);
bool game_a_lgfx_slot_info_impl(int slot_id, int *role, int *state, uint32_t *map_token, uint32_t *tileset_token, int *load_stage, size_t *loaded_bytes, size_t *total_bytes, int *ref_count, int *waiter_count, bool *is_active);
void game_a_lgfx_slot_set_role_impl(int slot_id, int role);
void game_a_lgfx_display_wait_idle_impl(void);
bool game_a_lgfx_tile_set_impl(int tx, int ty, int tile_index);
int game_a_lgfx_tile_render_impl(int scroll_x, int scroll_y, bool force_full);
int game_a_lgfx_tile_render_player_impl(int scroll_x, int scroll_y, int player_x, int player_y, uint16_t color, int radius, bool force_full);
int game_a_lgfx_tile_render_player_enemy_impl(int scroll_x, int scroll_y, int player_x, int player_y, uint16_t color, int radius,
                                       int enemy_x, int enemy_y, int enemy_frame, bool enemy_enabled, bool force_full);
void game_a_lgfx_draw_player_impl(int x, int y, uint16_t color, int radius);
bool game_a_lgfx_player_sheet_load_impl(const uint8_t *sheet_data, size_t sheet_len, int sheet_w, int sheet_h, int frame_w, int frame_h);
bool game_a_lgfx_player_sheet_load_file_impl(const char *sheet_path, int sheet_w, int sheet_h, int frame_w, int frame_h);
void game_a_lgfx_player_frame_set_impl(int frame_index);
void game_a_lgfx_player_flip_x_set_impl(bool flip_x);
void game_a_lgfx_player_sheet_clear_impl(void);
bool game_a_lgfx_enemy_sheet_load_file_impl(const char *sheet_path, int sheet_w, int sheet_h, int frame_w, int frame_h);
void game_a_lgfx_enemy_frame_set_impl(int frame_index);
void game_a_lgfx_enemy_sheet_clear_impl(void);
void game_a_lgfx_enemy_draw_impl(int x, int y);
void game_a_lgfx_enemy_overlay_clear_impl(void);
void game_a_lgfx_interact_hint_begin_impl(void);
void game_a_lgfx_interact_hint_rect_impl(int slot_id, int x, int y, int w, int h, int phase_step);
void game_a_lgfx_interact_hint_circle_impl(int slot_id, int cx, int cy, int r, int phase_step);
void game_a_lgfx_interact_hint_end_impl(void);
void game_a_lgfx_interact_hint_clear_impl(void);
bool game_a_lgfx_draw_png_file_impl(const char *path, int x, int y, int w, int h);
bool game_a_lgfx_png_slot_load_file_impl(int slot_id, const char *path);
bool game_a_lgfx_png_slot_draw_impl(int slot_id, int x, int y, int w, int h);
void game_a_lgfx_png_slot_release_impl(int slot_id);
void game_a_lgfx_png_slot_release_all_impl(void);
void game_a_lgfx_get_stats_impl(uint32_t *full_frames, uint32_t *dirty_frames, uint32_t *last_us, uint32_t *last_tiles);
#ifdef __cplusplus
}
#endif

static mp_obj_t lgfx_init(void) {
    game_a_lgfx_init_impl();
    return mp_const_none;
}
static MP_DEFINE_CONST_FUN_OBJ_0(lgfx_init_obj, lgfx_init);

static mp_obj_t lgfx_fill(mp_obj_t color_obj) {
    game_a_lgfx_fill_impl((uint16_t)mp_obj_get_int(color_obj));
    return mp_const_none;
}
...
static mp_obj_t lgfx_draw_rect(size_t n_args, const mp_obj_t *args) {
    ...
    game_a_lgfx_draw_rect_impl(x, y, w, h, color);
    return mp_const_none;
}
...
static mp_obj_t lgfx_draw_text(size_t n_args, const mp_obj_t *args) {
    ...
    game_a_lgfx_draw_text_impl(x, y, text, color);
    return mp_const_none;
}
...
static mp_obj_t lgfx_set_brightness(mp_obj_t brightness_obj) {
    game_a_lgfx_set_brightness_impl(mp_obj_get_int(brightness_obj));
    return mp_const_none;
}
...
static mp_obj_t lgfx_set_swap_bytes(mp_obj_t swap_obj) {
    game_a_lgfx_set_swap_bytes_impl(mp_obj_is_true(swap_obj));
    return mp_const_none;
}
...
static mp_obj_t lgfx_sprite_create(size_t n_args, const mp_obj_t *args) {
    ...
    game_a_lgfx_sprite_create_impl(w, h, use_psram);
    return mp_const_none;
}
...
static mp_obj_t lgfx_sprite_fill(mp_obj_t color_obj) {
    game_a_lgfx_sprite_fill_impl((uint16_t)mp_obj_get_int(color_obj));
    return mp_const_none;
}
...
static mp_obj_t lgfx_sprite_push(mp_obj_t x_obj, mp_obj_t y_obj) {
    ...
    game_a_lgfx_sprite_push_impl(x, y);
    return mp_const_none;
}
...
static mp_obj_t lgfx_tile_setup(size_t n_args, const mp_obj_t *args) {
    ...
    return mp_obj_new_bool(game_a_lgfx_tile_setup_impl(tile_size, map_w, map_h, view_w, view_h, use_psram));
}
...
static mp_obj_t lgfx_tile_load(mp_obj_t tileset_obj, mp_obj_t tilemap_obj) {
    ...
    bool ok = game_a_lgfx_tile_load_impl(
...
static mp_obj_t lgfx_tile_load_files(mp_obj_t tileset_path_obj, mp_obj_t tilemap_path_obj) {
    ...
    return mp_obj_new_bool(game_a_lgfx_tile_load_files_impl(tileset_path, tilemap_path));
}
static MP_DEFINE_CONST_FUN_OBJ_2(lgfx_tile_load_files_obj, lgfx_tile_load_files);

static mp_obj_t lgfx_tile_loader_mode(void) {
    return mp_obj_new_int(game_a_lgfx_tile_loader_mode_impl());
}
...
static mp_obj_t lgfx_tile_last_error(void) {
    return mp_obj_new_int(game_a_lgfx_tile_last_error_impl());
}
...
static mp_obj_t lgfx_slot_load_files(size_t n_args, const mp_obj_t *args) {
    ...
    return mp_obj_new_bool(game_a_lgfx_slot_load_files_impl(slot_id, map_token, tileset_token, tileset_path, tilemap_path, tile_size, map_w, map_h));
}
...
static mp_obj_t lgfx_slot_begin_load_files(size_t n_args, const mp_obj_t *args) {
    ...
    int map_w = mp_obj_get_int(args[6]);
    int map_h = mp_obj_get_int(args[7]);
    return mp_obj_new_bool(game_a_lgfx_slot_begin_load_files_impl(slot_id, map_token, tileset_token, tileset_path, tilemap_path, tile_size, map_w, map_h));
}
...
static mp_obj_t lgfx_slot_pump_load(size_t n_args, const mp_obj_t *args) {
    ...
    return mp_obj_new_int(game_a_lgfx_slot_pump_load_impl(slot_id, max_bytes));
}
...
static mp_obj_t lgfx_slot_cancel_load(mp_obj_t slot_id_obj) {
    return mp_obj_new_bool(game_a_lgfx_slot_cancel_load_impl(mp_obj_get_int(slot_id_obj)));
}
...
static mp_obj_t lgfx_slot_select(size_t n_args, const mp_obj_t *args) {
    ...
    return mp_obj_new_bool(game_a_lgfx_slot_select_impl(slot_id, force_full_redraw));
}
...
static mp_obj_t lgfx_slot_has_map(mp_obj_t slot_id_obj, mp_obj_t map_token_obj) {
    ...
    return mp_obj_new_bool(game_a_lgfx_slot_has_map_impl(slot_id, map_token));
}
...
static mp_obj_t lgfx_slot_info(mp_obj_t slot_id_obj) {
    ...
    if (!game_a_lgfx_slot_info_impl(slot_id, &role, &state, &map_token, &tileset_token, &load_stage, &loaded_bytes, &total_bytes, &ref_count, &waiter_count, &is_active)) {
        return mp_const_none;
    }
    mp_obj_t tuple[10];
...
static mp_obj_t lgfx_tile_set(mp_obj_t tx_obj, mp_obj_t ty_obj, mp_obj_t idx_obj) {
    ...
    return mp_obj_new_bool(game_a_lgfx_tile_set_impl(tx, ty, idx));
}
...
static mp_obj_t lgfx_tile_render_player(size_t n_args, const mp_obj_t *args) {
    ...
    int mode = game_a_lgfx_tile_render_player_impl(scroll_x, scroll_y, player_x, player_y, color, radius, force_full);
    return mp_obj_new_int(mode);
}
...
static mp_obj_t lgfx_tile_render_player_enemy(size_t n_args, const mp_obj_t *args) {
    ...
    int mode = game_a_lgfx_tile_render_player_enemy_impl(
...
static mp_obj_t lgfx_draw_player(size_t n_args, const mp_obj_t *args) {
    ...
    game_a_lgfx_draw_player_impl(x, y, color, radius);
    return mp_const_none;
}
...
static mp_obj_t lgfx_player_sheet_load(size_t n_args, const mp_obj_t *args) {
    ...
    bool ok = game_a_lgfx_player_sheet_load_impl(
...
static mp_obj_t lgfx_player_sheet_load_file(size_t n_args, const mp_obj_t *args) {
    ...
    int frame_w = mp_obj_get_int(args[3]);
    int frame_h = mp_obj_get_int(args[4]);
    bool ok = game_a_lgfx_player_sheet_load_file_impl(sheet_path, sheet_w, sheet_h, frame_w, frame_h);
    return mp_obj_new_bool(ok);
}
...
static mp_obj_t lgfx_player_frame_set(mp_obj_t frame_index_obj) {
    game_a_lgfx_player_frame_set_impl(mp_obj_get_int(frame_index_obj));
    return mp_const_none;
}
...
static mp_obj_t lgfx_player_flip_x_set(mp_obj_t flip_obj) {
    game_a_lgfx_player_flip_x_set_impl(mp_obj_is_true(flip_obj));
    return mp_const_none;
}
...
static mp_obj_t lgfx_player_sheet_clear(void) {
    game_a_lgfx_player_sheet_clear_impl();
    return mp_const_none;
}
...
static mp_obj_t lgfx_enemy_sheet_load_file(size_t n_args, const mp_obj_t *args) {
    ...
    int frame_w = mp_obj_get_int(args[3]);
    int frame_h = mp_obj_get_int(args[4]);
    bool ok = game_a_lgfx_enemy_sheet_load_file_impl(sheet_path, sheet_w, sheet_h, frame_w, frame_h);
    return mp_obj_new_bool(ok);
}
...
static mp_obj_t lgfx_enemy_frame_set(mp_obj_t frame_index_obj) {
    game_a_lgfx_enemy_frame_set_impl(mp_obj_get_int(frame_index_obj));
    return mp_const_none;
}
...
static mp_obj_t lgfx_enemy_sheet_clear(void) {
    game_a_lgfx_enemy_sheet_clear_impl();
    return mp_const_none;
}
...
static mp_obj_t lgfx_interact_hint_begin(void) {
    game_a_lgfx_interact_hint_begin_impl();
    return mp_const_none;
}
...
static mp_obj_t lgfx_interact_hint_rect(size_t n_args, const mp_obj_t *args) {
    ...
    game_a_lgfx_interact_hint_rect_impl(slot_id, x, y, w, h, phase_step);
    return mp_const_none;
}
...
static mp_obj_t lgfx_interact_hint_circle(size_t n_args, const mp_obj_t *args) {
    ...
    game_a_lgfx_interact_hint_circle_impl(slot_id, cx, cy, r, phase_step);
    return mp_const_none;
}
...
static mp_obj_t lgfx_interact_hint_end(void) {
    game_a_lgfx_interact_hint_end_impl();
    return mp_const_none;
}
...
static mp_obj_t lgfx_interact_hint_clear(void) {
    game_a_lgfx_interact_hint_clear_impl();
    return mp_const_none;
}
...
static mp_obj_t lgfx_draw_png_file(size_t n_args, const mp_obj_t *args) {
    ...
    int w = mp_obj_get_int(args[3]);
    int h = mp_obj_get_int(args[4]);
    return mp_obj_new_bool(game_a_lgfx_draw_png_file_impl(path, x, y, w, h));
}
...
static mp_obj_t lgfx_png_slot_load_file(mp_obj_t slot_id_obj, mp_obj_t path_obj) {
    ...
    return mp_obj_new_bool(game_a_lgfx_png_slot_load_file_impl(slot_id, path));
}
...
static mp_obj_t lgfx_png_slot_draw(size_t n_args, const mp_obj_t *args) {
    ...
    int w = mp_obj_get_int(args[3]);
    int h = mp_obj_get_int(args[4]);
    return mp_obj_new_bool(game_a_lgfx_png_slot_draw_impl(slot_id, x, y, w, h));
}
...
static mp_obj_t lgfx_png_slot_release(mp_obj_t slot_id_obj) {
    game_a_lgfx_png_slot_release_impl(mp_obj_get_int(slot_id_obj));
    return mp_const_none;
}
...
static mp_obj_t lgfx_png_slot_release_all(void) {
    game_a_lgfx_png_slot_release_all_impl();
    return mp_const_none;
}
...
static mp_obj_t lgfx_stats(void) {
    ...
    game_a_lgfx_get_stats_impl(&full_frames, &dirty_frames, &last_us, &last_tiles);
    mp_obj_t tuple[4];
...
static const mp_rom_map_elem_t lgfx_module_globals_table[] = {
    { MP_ROM_QSTR(MP_QSTR___name__), MP_ROM_QSTR(MP_QSTR_game_a_native) },
...
const mp_obj_module_t game_a_native_user_cmodule = {
    .base = { &mp_type_module },
    .globals = (mp_obj_dict_t *)&lgfx_module_globals,
};

MP_REGISTER_MODULE(MP_QSTR_game_a_native, game_a_native_user_cmodule);
